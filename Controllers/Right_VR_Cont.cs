...
public class Right_VR_Cont : MonoBehaviour
{
    ...
    public Valve.VR.EVRButtonId rightJoystick = Valve.VR.EVRButtonId.k_EButton_SteamVR_Touchpad;

    public SteamVR_Controller.Device controller { get { return SteamVR_Controller.Input((int)trackedObj.index); }/*get { return SteamVR_Controller.Input(SteamVR_Controller.GetDeviceIndex(SteamVR_Controller.DeviceRelation.Rightmost)); }*/ }
    ...
    void OnEnable()
    {
        Singleton_Service.RegisterSingletonInstance<Right_VR_Cont>(this);
        if (sheath != null)
        {
            sheath.rightController = this;
        }
        trackedObj = GetComponent<SteamVR_TrackedObject>();
    ...
    void OnDisable()
    {
        Singleton_Service.UnregisterSingletonInstance<Right_VR_Cont>(this);
    }
}
